...
const persistAssessmentQuestion = async (tx, data) => {
  try {
    const result = await tx.$queryRawUnsafe(
      'INSERT INTO "assessment_questions" ("id", "assessment_id", "question_text", "marks", "display_order", "status", "createdAt", "updatedAt") VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW()) RETURNING "id"',
      generateRecordId(),
      data.assessmentId,
      data.questionText,
      Number(data.marks) || 1,
