          ...
          <Accordion sx={{ boxShadow: 3, position: 'relative' }} key={chapter.id} sx={{ marginBottom: '10px' }}>
            ...
            >
              <Box display='flex' width='100%' justifyContent='space-between' >
                <Box display='flex'>
                    <Avatar onClick={(e) => {e.stopPropagation(); router.push(`./Chapter/ChapterNotes/${chapter.id}`)}} sx={{ bgcolor: '#fbfbfb', color: 'black', padding: '5px', display: 'flex', height: '70px', width: '70px', flexDirection: 'column', border: '4px lightGray solid' }}> 
